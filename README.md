# Musician (v0.1.0)
A webapp with musical ingredients for music lovers *(to be modified later)*

## Slogant
Surrander experiments

## Introduction
This repository is currently in the mode for testing purposes, hoping to be built up.
...
the *musje* grammar could not be gracefully expaned to produce it in the larger domain range as of **Musician**.
